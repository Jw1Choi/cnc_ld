...
<div style="text-align:-webkit-center;border:2px solid #000;border-radius:10px;width:95%;padding:10px 20px;max-width:450px;" > 
	<a href="#sec05" class="scroll box">
					...
					<span class="timer" style="color:#000;font-weight:700;">
						⏰  혜택 마감 | <span id="day3" style="font-weight:700;"></span> ( <span id="countdown3" style="font-weight:700;"></span>)
						</span>
					  </a> </div><br><br>
    ...
    <div class="form-box-inner">
        <form action="" id="form_e12" method="POST" target="hidden_iframe11" onsubmit="dll(); submitted=true;">
          <input type="hidden" name="entry.925560115" value="당근">
            ...
            <br>
                <table class="form-box-tb">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='text' name='entry.286048134' id='name1' class="form-control" placeholder="성함" maxlength="4">
                        </td>
                    </tr>
            ...
            <tr>
              ...
              <td>
                  <input type='text' name='entry.440436541' id='phone1' class="form-control" placeholder="휴대폰번호" maxlength="11">
              </td>
          </tr>

          <tr id="select_lic">
                        <th>자녀 학년<br>
                        <span style="color:red; font-size:12px;" id="currentDate"></span></th>
                        <td>
    
                            <select name='entry.449270036' id='db1' class="form-control" placeholder="현재 조건">
                   ...
                   <!-- <tr>
                    ...
                    <tr>
                        <td colspan="2" style="border-bottom: none"> 
                            ...
                            <input class="submit-btn" type='submit' id='send_message1' value='무료 체험 신청하기' disabled >
...
<section id="dbscf" style="display:none;">
  <form id="db" name="f2" accept-charset="euc-kr" method="post" action="https://dbdbdeep.com/new/mct/ifr/ifr_save.php" target="hidden_iframe12">
<input type="hidden" name="ms" value="S00277989K" />
<input type="hidden" name="ca" value="C05839935Q" />
