...
<div id="wrap" >
			  ...
			  <form action="" id="form_e11" method="POST" target ="hidden_iframe11" onsubmit=" submitted=true;"> 
					<div class="wow fadeIn bbackg"> 
							 ...
							 <section  id="main_intro" class="backg" style="text-align: center;" >
							  ...
							  <div class="img-text" style="font-size:23px;">
							  <center><h1><span class="questm ft-white">신년 맞이 무료 상담 이벤트!<br>CUT & CUT DIET<br>감량 부위 최대 감량치는?</span></h1></center><br>
							  ...
							  <div class="row counters">
								...
								<div class="col-lg-4 col-4 text-center">
								  <span>- </span><span class="counter">13</span><span >kg (4주)</span>
								  <p>체지방 감소</p>
								</div>
					  ...
					  <center><input name="entry.intro" id="quests_1" class="input_font quest8" type="radio" value="시작하기" style="text-align:center;" >
					  <label class="label_button1 sub_click" id="start1" for="quests_1" onclick="go_gw()"><span style="font-size: 16px;"></span><span >시작하기</span></label><Br>
		...
		<label class="label_button1 disabled" id="next_nw" for="quest2_1" style="text-align:Center;" onclick="go_height()">다음</label></center>	
						 ...
						 <!--나는 어떤 부모인가요?-->
								 ...
								 <script>
									function focus(){
										$('#weight').attr("autofocus","autofocus");
									}
								 </script>
					 ...
					 <center><input name="entry.quest0" id="quest0_1" class="input_font quest0 " type="radio" value="다음" style="text-align:center;" disabled="disabled">
						 ...
						 <footer id="footer" class="section-bg">
						  <div class="footer-top">
							<div class="container">
							  <div class="row">
									<span>감량효과는 개인별 차이가 있을 수 있습니다.</span><br>
